...
// import MenuDashboard from './DashboardList'
// import Wgnerdashboard from './Wgnerdashboard'
...
import MenuRoutes from '../../src/Routes/Dashboardroutes'
...
<main style={{  position: "relative", top: -615, left: 91}} id="content" role="main" class="main">
...
{/* <Router>
    ...
    <Link to="/DashboardGrid">Dashboard</Link>
    </Router> */}
...
<NavLink to="/DashboardGrid">Dashboard</NavLink> */}
...
{/* <Router> */}
              {/* <Menu defaultSelectedKeys={['1']} bordered={ false} mode="horizontal">
        <Menu.Item key="1" icon={<MailOutlined />}>
        <Link to="/Userprofile">Users</Link> */}
        {/* <div className="User_menu">
       <a className="UserPro" href="Userprofile">
          User
          </a> */}

        {/* </Menu.Item>
        <Menu.Item key="2"  icon={<AppstoreOutlined />}> */}
        {/* <a className="Dashbo" href="Dashboard">Dashboard</a>
        </div> */}
        {/* </Menu.Item>
     </Menu> */}
     {/* </Router> */}
...
{/*               
           ...
           {/* <div class="js-nav-scroller hs-nav-scroller-horizontal mb-5">
            ...
            {/* <!-- Nav -->
            @@include("@@autopath/partials/layouts-components/nav-menu-user-profile.html", {
              "link": "user-profile.html"
            })
            <!-- End Nav --> */}

             {/* <div class="row" style={{width: 853, position:"relative", top:225, right: 124}}>
              <div class="col-lg-4">
              ...
              {/* <div class="col-lg-8">
               ...
               /*  <div class="card mb-3 mb-lg-5">
                  ...
                  <div class="card-body card-body-height" style={{height: 30}}>
                          ...
                          <div class="step-content">
                            ...
                            <ul class="list-group">
                              ...
                              <li class="list-group-item list-group-item-light">
                                <div class="row gx-1">
                                  <div class="col">
                                    <img class="img-fluid rounded ie-card-img" src="/svg/illustrations/card-1.svg" alt="Image Description"/>
                                  </div>
                                  <div class="col">
                                    <img class="img-fluid rounded ie-card-img" src="/svg/illustrations/card-2.svg" alt="Image Description"/>
                                  </div>
                                  <div class="col">
                                    <img class="img-fluid rounded ie-card-img" src="/svg/illustrations/card-3.svg" alt="Image Description"/>
                                  </div>
                                  <div class="col">
                                    <img class="img-fluid rounded ie-card-img" src="/svg/illustrations/card-4.svg" alt="Image Description"/>
                                  </div>
                                  <div class="col">
                                    <img class="img-fluid rounded ie-card-img" src="/svg/illustrations/card-5.svg" alt="Image Description"/>
                                  </div>
                        ...
                        <ul class="list-unstyled list-unstyled-py-4 mb-0">
                            ...
                            <div class="d-flex align-items-center">
                              <a class="d-flex align-items-center mr-2" href="#">
                                <div class="avatar avatar-sm avatar-circle">
                                  <img class="avatar-img" src="/img/160x160/img8.jpg" alt="Image Description"/>
                          ...
                          <li>
                            <div class="d-flex align-items-center">
                              <a class="d-flex align-items-center mr-2" href="#">
                                <div class="avatar avatar-sm avatar-circle">
                                  <img class="avatar-img" src="/img/160x160/img3.jpg" alt="Image Description"/>
                                  <span class="avatar-status avatar-sm-status avatar-status-warning"></span>
                                </div>
                                <div class="ml-3">
                          ...
                          <li>
                            <div class="d-flex align-items-center">
                              <a class="d-flex align-items-center mr-2" href="#">
                                <div class="avatar avatar-sm avatar-circle">
                                  <img class="avatar-img" src="/img/160x160/img6.jpg" alt="Image Description"/>
                    ...
                    <table class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>
                            <div class="d-flex">
                              <img class="avatar avatar-xs" src="/svg/brands/spec.svg" alt="Image Description"/>
                              <div class="ml-3">
                        ...
                        <tr>
                          <td>
                            <div class="d-flex">
                              <img class="avatar avatar-xs" src="/svg/brands/capsule.svg" alt="Image Description"/>
                              <div class="ml-3">
                        ...
                        <tr>
                          <td>
                            <div class="d-flex">
                              <img class="avatar avatar-xs" src="/svg/brands/mailchimp.svg" alt="Image Description"/>
                              <div class="ml-3">
                        ...
                        <tr>
                          <td>
                            <div class="d-flex">
                              <img class="avatar avatar-xs" src="/svg/brands/figma.svg" alt="Image Description"/>
                              <div class="ml-3">
